      ...
      (t.tokenizer = function (e, r) {
        ...
        if (Array.isArray(e))
          return e.map(function (p) {
            return new t.Token(t.utils.asString(p).toLowerCase(), t.utils.clone(r));
          });
        for (
          var n = e.toString().toLowerCase(), i = n.length, s = [], o = 0, a = 0;
          o <= i;
          o++
        ) {
          var u = n.charAt(o),
...
`,
                ...
                for (
                  ...
                  if (
                    (l.presence == t.Query.presence.REQUIRED &&
                      ((p = p.union($)), o[m] === void 0 && (o[m] = t.Set.complete)),
      ...
      (t.Builder = function () {
        ...
        (t.MatchData = function (e, r, n) {
          ...
          (this.metadata = Object.create(null)),
            e !== void 0 &&
              ((this.metadata[e] = Object.create(null)), (this.metadata[e][r] = i));
        }),
  ...
  var oe = class {
      ...
      addClass(e) {
        return (
          this.signature.classList.add(e), this.description.classList.add(e), this
        );
      }
      removeClass(e) {
        return (
